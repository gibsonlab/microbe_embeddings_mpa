...
if __name__ == "__main__":
    main(
        marker_fasta_file=Path("/data/cctm/youn/metaphlan_dset/phylophlan_data/processed/dna_only") / "markers.fna",
        output_json_path=Path("/data/cctm/youn/metaphlan_dset/phylophlan_data/processed/dna_only") / "sgb_marker_index.json.zst",  # should end with ".zst" extension -- will be compressed using zstd.
    )
