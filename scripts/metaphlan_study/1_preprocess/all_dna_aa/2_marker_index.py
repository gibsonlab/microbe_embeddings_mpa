...
if __name__ == "__main__":
    main(
        marker_fasta_file=Path("/data/bwh-comppath-seq/youn/metaphlan_dset/phylophlan_database/processed/all") / "all_markers.fna",
        output_json_path=Path("/data/bwh-comppath-seq/youn/metaphlan_dset/phylophlan_database/processed/all") / "sgb_marker_index.json.zst",  # should end with ".zst" extension -- will be compressed using zstd.
    )
